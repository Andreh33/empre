    ...
    <div className="min-h-screen bg-secondary">
      <header className="border-b bg-brand text-white">
        ...
        <nav className="container flex gap-4 overflow-x-auto pb-2 text-sm text-white/80">
          ...
          <Link href="/admin/documentos" className="hover:text-gold">
            Documentos
          </Link>
          <Link href="/admin/mensajes" className="hover:text-gold">
            Mensajes
          </Link>
          <Link href="/admin/calendario" className="hover:text-gold">
            Calendario
          </Link>
          <Link href="/admin/auditoria" className="hover:text-gold">
            Auditoria
          </Link>
